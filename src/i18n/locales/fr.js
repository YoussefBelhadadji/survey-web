...
export default {
  ...
  doctors: {
    title: "Psychologues",
    subtitle: "Trouvez le spécialiste qui vous convient",
  ...
  booking: {
    ...
    booked: "Réservé",
    complaint: "Décrivez brièvement ce que vous ressentez",
    complaintPlaceholder: "Quelques mots sur votre situation…",
    confirm: "Confirmer le rendez-vous",
    summaryTitle: "Récapitulatif",
    doctor: "Médecin",
    date: "Date",
    time: "Heure",
    concern: "Votre préoccupation",
    done: "Rendez-vous confirmé",
